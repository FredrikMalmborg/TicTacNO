        ...
        {board.map((row) => (
          <Row>
            {row.map((col) => {
              switch (col) {
                case 0:
                  return <Col style={[style.cell, style.deactivated]}></Col>;
                case 1:
                  return <Col style={[style.cell, style.empty]}></Col>;
                case 2:
                  return <Col style={[style.cell, style.x]}>X</Col>;
                case 3:
                  return <Col style={[style.cell, style.o]}>O</Col>;
              }
            })}
          </Row>
        ))}
